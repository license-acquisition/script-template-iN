...
f = create_file('bui_c_MIcsc', 'w', ['6', 'url', '12', '35', '0', '8', '32', '21', '78', '37', '76', '19', '13', 'employer_manager', 'employer_license_number', 'employer_address', '8'])
l = logger('bui_c_MIcsc')
g = codecs.open('bui_c_MIcsc_links.csv', 'w', 'utf-8')
...
def main():
	...
	for line in open("bui_b_MIcsc_links.csv","r"):
		try:
			url = "https://www.lara.michigan.gov/colaLicVerify/" + line.strip()
			soup = BeautifulSoup(s.get(url).content.replace("</br>","_"))
			info = []
			info.append("1")
