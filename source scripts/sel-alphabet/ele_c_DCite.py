...
f = codecs.open('ele_c_DCitb_%s_000.txt' %(time.strftime('%Y%m%d')), 'w', 'utf-8')
...
for letter1 in alphabet: # original: no subsets!
    for letter2 in alphabet:
        for letter3 in alphabet:
            browser.get("https://www.asisvcs.com/services/licensing/DCOPLA/search_page.asp?CPCAT=3609STATEREG")
