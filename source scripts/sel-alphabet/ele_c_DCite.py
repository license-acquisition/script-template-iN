...
def main():
    ...
    for term in keywords:
        driver.get("https://www.asisvcs.com/services/licensing/DCOPLA/search_page.asp?CPCAT=3609STATEREG")
        l.info(' - - - - - Searching %s - - - - - ' %(term))
        driver.find_element_by_xpath('//*[@id="mainContent"]/form/table/tbody/tr[1]/td[2]/input[2]').click()
        driver.find_element_by_xpath('//*[@id="mainContent"]/form/table/tbody/tr[3]/td[3]/input').send_keys(term)
